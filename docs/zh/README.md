...
欢迎使用 fqc (fq-compressor-rust) 技术文档。
...
| [algorithms.md](algorithms.md) | 压缩算法详解 (ABC / SCM / 重排序) | 算法研究者、性能优化者 |
| [development.md](development.md) | 开发指南、测试、CI/CD、发布流程 | 项目贡献者 |
| [performance.md](performance.md) | 性能调优、性能分析、基准测试 | 运维、性能工程师 |
