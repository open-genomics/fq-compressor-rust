...
hero:
  ...
  tagline: "A block-indexed .fqc archive tool for compressing, restoring, inspecting, and verifying FASTQ data."
  image:
    src: /logo.svg
    alt: fqc logo
  actions:
...
Start with the [Quick Start](/en/guide/quick-start) if you want the shortest path from FASTQ to .fqc, or jump to the [CLI reference](/en/guide/cli) for flags and mode details.
