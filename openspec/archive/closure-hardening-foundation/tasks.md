...
- [x] Audit the repository baseline and record the concrete drift points.
- [x] Create canonical `openspec/` living specs for governance, workflow, docs, release operations, metadata, and CLI surface.
- [x] Remove the legacy `specs/` tree.
- [x] Rewrite the root documentation set (`README`, `CHANGELOG`, `CONTRIBUTING`, `SECURITY`, AI guidance).
