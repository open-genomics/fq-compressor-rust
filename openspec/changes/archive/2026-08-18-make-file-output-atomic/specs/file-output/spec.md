# File Output Change Specification
...
POSIX cannot atomically rename two paths; if the second commit fails after the
first, the implementation SHALL report the error and document the limitation.
